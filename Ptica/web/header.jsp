...
<%  final String URL_EMP_ADM = "ptica/zaposleni"; // the URL for employees and administrators
    final String URL_CUST = "ptica"; // the URL for customers
%>
    ...
    <body class="greybckgr"> <!-- greybckgr - class which defines grey background (templatecss.css) -->
        <div class="container">
            ...
            <%
                ...
                attr_found = PticaMetodi.sessVarExists(hSession1, "emp_adm"); // sessVarExists: returns whether the session var. emp_adm exists in the session
            ...
            <!-- the Bootstrap column takes 12 columns on the large screens, 12 columns on the medium sized screens,
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"> 
                    ...
                    <nav class="navbar navbar-expand-md navbar-light bg-light">
                        ...
                        <a class="navbar-brand" href="AddSessVar" onclick = "cookieFillIn('index.jsp')">Ptica</a> <!-- name of the company -->
